...
def create_chat():
    ...
    return chat, {"embed_models_dd": embedding_choice_dd, "embed_textbox": embed_textbox, "lang_models_dd": lang_model_choice_dd, "lang_textbox": lang_textbox, "rule_systems_dd": available_rule_systems_dd}
