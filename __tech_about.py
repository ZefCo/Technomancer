...
with gr.Blocks() as about:
    ...
    note_embedding_note = gr.Markdown("This will auto detect and sort your models by langauge and embedding models. This ASSUMES your embedding model is in the list of models found the in the Settings folder. If it is not, please add it and restart Technomancer.")
