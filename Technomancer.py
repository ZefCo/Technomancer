...
from __states import (avatars_state, 
                      ...
                      name_chunksize_state, name_embed_state, name_lang_state, name_rule_state, named_chunkoverlap_state, name_tags_state, name_threshold_state, name_chunkbatch_state, name_chunksum_state,
...
def launch_technomancer():
    ...
    with gr.Blocks(title = "Technomancer v1.0") as Technomancer:
        ...
        name_chunkbatch_state.render(), name_chunksum_state.render(), name_chunksize_state.render(), named_chunkoverlap_state.render(), name_embed_state.render(), name_lang_state.render(), name_rule_state.render(), name_tags_state.render(), name_threshold_state.render()
