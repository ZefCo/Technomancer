...
from __tech_fn import sort_models
...
with gr.Blocks(title = "Technomancer v0.5") as Technomancer:
    ...
    # rule_systems = gr.State(value = RULE_SYSTEMS)  # this will be moved into 
    with gr.Tabs():
        ...
        with gr.Tab(label = "Technomancer Chat"):
            ...
            TECH_CHAT = create_chat(system_content, rule_systems, lang_models)

        with gr.Tab(label = "Database of Holding"):
            TECH_UPLOAD = create_upload(rule_systems, embed_models)
